        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Admins_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassPupils", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassPupils_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassPupils_Pupils_PupilId",
                        column: x => x.PupilId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassPupils_ClassId_PupilId",
                table: "ClassPupils",
                columns: new[] { "ClassId", "PupilId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassPupils_PupilId",
                table: "ClassPupils",
                column: "PupilId");
